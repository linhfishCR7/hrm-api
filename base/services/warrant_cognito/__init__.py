...
class Cognito(object):
    ...
    def _add_secret_hash(self, parameters, key):
        ...
        """
        # print(self.client_id, parameters['Username'])
        if self.client_secret is not None:
            secret_hash = AWSSRP.get_secret_hash(parameters['Username'], self.client_id,
                                                 self.client_secret)
    ...
    def admin_set_user_password(self, password, permanent=True, username=None):
        """
